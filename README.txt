...
Every operation it will take as an input 2 arguments.
...
If you are an avanced user you can also install this package form pip under the name calculator_val. 
